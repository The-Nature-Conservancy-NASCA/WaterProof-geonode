...
### Flood Mitigation – FastFlood

WaterProof expands its analytical capabilities through the Flood Mitigation module, which incorporates FastFlood, a rapid flood modeling approach designed to support the assessment of Nature-based Solutions (NbS) for flood risk reduction. This module allows users to compare baseline and NbS scenarios by estimating changes in flood extent and flood depth, and evaluating the associated avoided damages across different land-use categories. Based on these results, WaterProof estimates the economic benefits generated by NbS interventions and integrates them into a Return on Investment (ROI) analysis. The module provides a rapid and indicative assessment intended to support early-stage planning and decision-making, helping users identify where NbS interventions may provide greater benefits for flood mitigation.
