...
urlpatterns = [
    ...
    path('<int:idx>', views.reportMenu, name='report-menu'),
    
    path('data', views.pivot_data, name='pivot_data_fastflood'),
    path('physical/<int:idx>', views.physicalIndicators, name='physical_fastflood'),
    path('financial/<int:idx>', views.financialIndicators, name='financial_fastflood'),
    path('decision/<int:idx>', views.decisionIndicators, name='decision_fastflood'),
    path('pdf/', views.pdf, name='pdf_fastflood'),
    # path('pdfgeo/', views.pdfgeo, name='pdfgeo_fastflood'),
    # path('pdfquick/', views.pdfQuick, name='pdfQuick_fastflood'),
    path('zip/<int:idx>', views.linkDownload, name='zip_fastflood'),
    path('geographic/', views.geographicIndicators, name='geographic_fastflood'),
    # path('quickGeographic/', views.quickGeographicIndicators, name='quick-geographic_fastflood'),
    
    path('getFloodMitigation/', api.getFloodMitigation, name='get-getFloodMitigation'),
    path('getHydrograph/', api.getHydrograph, name='getHydrograph'),
    path('getDisplayStatus/', api.getDisplayStatus, name='getDisplayStatus'),
    path('test/', api.testApi, name='get-test'),
    ...
    path('getIndicators/', api.getIndicators, name='getIndicators'),    
