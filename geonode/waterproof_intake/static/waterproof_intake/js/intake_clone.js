    ...
    $('#intakeNIBYMI').click(function () {
        ...
        for (let index = 0; index <= intakeNIYMI; index++) {
            ...
            <tr>
                ...
                <td class="text-center"><input name="manualInputData" oninput="validity.valid||(value='');" min="0" yearValue="${index}" type="text" class="form-control justify-number"></td>
              </tr>
            `);
        }
    });
                ...
                if (extractionData.externaldata.length > 0) {
                    ...
                    for (const iterator of extractionData.externaldata) {
                        rows += (`<tr>
                                    ...
                                    <td class="text-center" scope="col"><input type="number" oninput="validity.valid||(value='');" class="form-control justify-number" value="${iterator.waterVol}" name="waterVolume_${iterator.year}_${extractionData.id}"></td>
                                    <td class="text-center" scope="col"><input type="number" oninput="validity.valid||(value='');" class="form-control justify-number" value="${iterator.sediment}" name="sediment_${iterator.year}_${extractionData.id}"></td>
                                    <td class="text-center" scope="col"><input type="number" oninput="validity.valid||(value='');" class="form-control justify-number" value="${iterator.nitrogen}" name="nitrogen_${iterator.year}_${extractionData.id}" ></td>
                                    <td class="text-center" scope="col"><input type="number" oninput="validity.valid||(value='');" class="form-control justify-number" value="${iterator.phosphorus}" name="phosphorus_${iterator.year}_${extractionData.id}"></td>
                            </tr>`);
                    }
        ...
        if (graphData[p].external == 'true') {
            ...
            for (let index = 0; index <= numYear; index++) {
                rows += (`<tr>
                            ...
                            <td class="text-center" scope="col"><input type="number" class="form-control justify-number" min="0" name="waterVolume_${index}_${graphData[p].id}"></td>
                            <td class="text-center" scope="col"><input type="number" class="form-control justify-number" min="0" name="sediment_${index}_${graphData[p].id}"></td>
                            <td class="text-center" scope="col"><input type="number" class="form-control justify-number" min="0" name="nitrogen_${index}_${graphData[p].id}" ></td>
                            <td class="text-center" scope="col"><input type="number" class="form-control justify-number" min="0" name="phosphorus_${index}_${graphData[p].id}"></td>
                        </tr>`);
            }
            $('#IntakeTDLE').append(`
