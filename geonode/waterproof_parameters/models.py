...
class Parameters_Biophysical(models.Model):
    ...
    usle_c = models.IntegerField(blank=True, null=True)
    ...
    load_p = models.IntegerField(blank=True, null=True)
    ...
    proportion_subsurface_n = models.IntegerField(blank=True, null=True)
    cn_a = models.IntegerField(blank=True, null=True)
    cn_b = models.IntegerField(blank=True, null=True)
    cn_c = models.IntegerField(blank=True, null=True)
    cn_d = models.IntegerField(blank=True, null=True)
    ...
    c_above = models.IntegerField(blank=True, null=True)
    c_below = models.IntegerField(blank=True, null=True)
    c_soil = models.IntegerField(blank=True, null=True)
    c_dead = models.IntegerField(blank=True, null=True)
    sed_exp = models.IntegerField(blank=True, null=True)
    sed_ret = models.IntegerField(blank=True, null=True)
    ...
    p_exp = models.IntegerField(blank=True, null=True)
