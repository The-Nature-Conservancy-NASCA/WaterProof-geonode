...
class StudyCases(models.Model):
    ...
    finance_Manager = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    administrative_Assistant = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    office_Costs = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    overhead = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    equipment_Purchased = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    vehicles_Purchased = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    equipment_Maintenance = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    vehicle_Maintenance = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    ...
    others = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    travel = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    contracts = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    analysis_type = models.CharField(max_length=15, blank=True, null=True)
