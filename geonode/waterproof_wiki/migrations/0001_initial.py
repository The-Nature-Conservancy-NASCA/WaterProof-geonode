    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contenido_en', ckeditor_uploader.fields.RichTextUploadingField(verbose_name='Content (En)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('articulo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Enlace', to='waterproof_wiki.Article')),
            ],
            options={
                'verbose_name': 'Enlace',
        ...
        migrations.AddField(
            model_name='article',
            name='categories',
            field=models.ManyToManyField(blank=True, null=True, to='waterproof_wiki.Category', verbose_name='Categorys'),
        ),
        migrations.AddField(
            model_name='article',
            name='referencies',
            field=models.ManyToManyField(blank=True, null=True, to='waterproof_wiki.Referencies', verbose_name='Referencies'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
