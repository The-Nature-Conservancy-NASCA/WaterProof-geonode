...
#DATABASE_URL='postgresql://geonode:*Uid!QXZ*6f@dev.skaphe.com:5432/waterproof'
...
GEOFENCE_SECURITY_ENABLED = False if TEST and not INTEGRATION else ast.literal_eval(
    os.getenv('GEOFENCE_SECURITY_ENABLED', 'True'))
...
try:
    ...
    # fallback to regular list of values separated with misc chars
    ALLOWED_HOSTS = [HOSTNAME, 'localhost', 'django', 'geonode', 'apps.skaphe.com', 'apps.skaphe.com:8000', 'water-proof.org', 'ec2-3-138-191-23.us-east-2.compute.amazonaws.com'] if os.getenv('ALLOWED_HOSTS') is None \
...
if GEONODE_CLIENT_LAYER_PREVIEW_LIBRARY == 'mapstore':
    ...
    if GEONODE_CATALOGUE_SERVICE:
        MAPSTORE_CATALOGUE_SERVICES[list(list(GEONODE_CATALOGUE_SERVICE.keys()))[0]
