...
def pdf(request):
    ...
    url_api = settings.SITE_HOST_API
    if base64_data != "data:,":
    ...
    studyCaseName = "-"
    requestJson = requests.get(url_api + 'reports/getSelectorStudyCasesId/?studyCase=' + study_case_id, verify=False)
    ...
    numerOfWater = "-"
    numerOfDwtp = "-"
    requestJson = requests.get(url_api + 'reports/getStudyCasesIntake/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    for item in data:
    ...
    requestJson = requests.get(url_api + 'reports/getReportAnalisysBeneficsB/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    for item in data:
    ...
    requestJson = requests.get(url_api +
 ...
 #   pdf.add_page()
    ...
    requestJson = requests.get(
        url_api + 'reports/getCaracteristicsPtapDetailPdf/?studyCase=' + study_case_id, verify=False)
...
#    pdf.add_page()
    ...
    requestJson = requests.get(url_api + 'reports/getconservationActivitiesPdf/?studyCase=' +
                               study_case_id, verify=False)
    ...
    requestJson = requests.get(
        url_api + 'reports/getFinancialAnalysisPdfRunAnalisisPdf/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    ...
    requestJson = requests.get(url_api + 'reports/getObjetivesForPorfoliosPdf/?studyCase=' +
                               study_case_id, verify=False)
    data = requestJson.json()
    ...
    requestJson = requests.get(url_api + 'reports/getCostAndBenefit/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    ...
    requestJson = requests.get(url_api + 'reports/getNetPresentValueSummary/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    ...
    requestJson = requests.get(
        url_api + 'reports/getSensibilityAnalysisBenefits/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
...
# Total discounted benefits
    ...
    requestJson = requests.get(url_api + 'reports/getSensibilityAnalysisCost/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    ...
    requestJson = requests.get(url_api + 'reports/getTotalBenefitsForMilion/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    dataEfficiency = []
    ...
    requestJson = requests.get(url_api + 'reports/getReportAnalisysBenefics/?studyCase=' + study_case_id, verify=False)
    ...
    requestJson = requests.get(
        url_api + 'reports/getReportOportunityResultIndicators/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    valueRoi = 0
    ...
    requestJson = requests.get(url_api + 'reports/getReportAnalisysBeneficsC/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    ...
    requestJson = requests.get(url_api + 'reports/getWpAqueductIndicatorGraph/?studyCase=' +
                               study_case_id, verify=False)
    data = requestJson.json()
    arrayTitle = []
    lastTitle = ""
    ...
    requestJson = requests.get(
        url_api + 'reports/getWaterproofReportsAnalysisBenefits/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    lastRegister = 0
    for item in data:
        if item['typeId'] == 'PTAP':
 ...
 #       pdf.ln(6)
    ...
    requestJson = requests.get(
        url_api + 'reports/getReportAnalysisBenefitsFilterSum/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    for item in data:
    ...
    requestJson = requests.get(url_api + 'reports/getReportCostsAnalysisFilter/?studyCase=' +
                               study_case_id, verify=False)
    data = requestJson.json()
    for item in data:
    ...
    requestJson = requests.get(
        url_api + 'reports/getReportCostsAnalysisFilterNbs/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
    for item in data:
    ...
    requestJson = requests.get(url_api + 'reports/getWpcompareMapas/?studyCase=' + study_case_id, verify=False)
    data = requestJson.json()
